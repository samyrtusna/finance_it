...
namespace Finance_it.API.Services.AuthServices
{
    public class AuthService : IAuthService
    {
        ...
        {
            var httpContext  = _httpContextAccessor.HttpContext ?? throw new UnauthorizedException("No HTTP context available.");
            ...
            _tokenServices.SetTokenToCookies(refreshToken.Token,httpContext.Response );
